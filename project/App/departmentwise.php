						...
						<div class="app-page-title">
                            <div class="page-title-wrapper">
								<div class="page-title-heading">
                                    ...
                                    <div>Department-wise student performance trend based on CGPA with respect to semesters.</div>
                                </div>
							</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Department-wise student performance trend
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <?php
                                                ...
                                                if($result-> num_rows>0){
                                                    ...
                                                    $res_departmentid = json_encode($array_departmentid);
